...
import { DashboardSummary, SalesChartItem, settlementDashboardApi } from '@/lib/api';
    ...
    <ErpLayout title="매출 대시보드">
      {loading ? (
        ...
        <>
          ...
          <div className="erp-card" style={{ minHeight: '300px', marginBottom: 12 }}>
            <h3>월간 매출 추이</h3>

            {salesChart.length === 0 ? (
              <p style={{ textAlign: 'center', color: 'var(--erp-text-muted)' }}>데이터가 없습니다.</p>
            ) : (
              ...
              <div style={{ width: '100%', height: 260 }}>
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={customerTop5} layout="vertical">
                    ...
                    <Tooltip formatter={(value) => [`${Number(value).toLocaleString()}원`, '매출액']} />
