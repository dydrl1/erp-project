    ...
    <>
      ...
      <div className="erp-card" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <button className="erp-btn primary" disabled={busy || checkedIn} onClick={handleCheckIn}>
            출근
          </button>
          <button className="erp-btn" disabled={busy || !checkedIn || checkedOut} onClick={handleCheckOut}>
            퇴근
          </button>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginTop: 12 }}>
        ...
        <button className="erp-btn" onClick={listData.reload}>
          조회
        </button>
      </div>
